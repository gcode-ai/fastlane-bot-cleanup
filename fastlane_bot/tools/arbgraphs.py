...
class Path(_DCBase):
    ...
    :staticdata:   list of nodes; the nodes can be any type that allows for equality comparison
...
class ArbGraph(_DCBase):
    ...
    def duplicate(self, consolidate=True):
        ...
        that cannot really be solved here unless we expand the staticdata structure of the edges
