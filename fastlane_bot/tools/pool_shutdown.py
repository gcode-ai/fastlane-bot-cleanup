...
from fastlane_bot.config_v2.abi import (
...
class AutomaticPoolShutdown:
    ...
    def main_sequence(self):
        ...
        self.mgr.cfg.logger.info(
            "Pool staticdata collected, checking vault token balances and comparing."
        )
    ...
    def generate_shutdown_tx(self, tkn: str) -> str:
        ...
        if transaction is not None:
            ...
            return self.tx_helpers.submit_private_transaction(
                signed_transaction, self.mgr.web3.eth.block_number
            )
        return None
