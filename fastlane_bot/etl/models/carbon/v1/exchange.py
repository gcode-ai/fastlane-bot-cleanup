...
Contains the exchange class for Carbon V1.
...
from fastlane_bot.etl.models.carbon.v1.abi import CARBON_CONTROLLER_ABI
...
@dataclass
class CarbonV1Exchange(BaseExchange):
    """
    Carbon exchange class
    """

    base_name: str = "carbon_v1"
    name: str = "carbon_v1"
    id: int = 6
    ...
    def add_pool(self, pool: CarbonV1Pool):
        self.pools[pool.state[CarbonV1Pool.unique_key()]] = pool
    ...
    def save_strategy(
        ...
        return func(
            address=self.CARBON_CONTROLLER_ADDRESS,
